...
class MaskSinGAN(BaseGAN):
    """MaskSinGAN.

    A modified version for SinGAN, the inputs of MaskSinGAN are images with masks, 
    masks are filled with fixed noise during training.
    mask could has different shape during inference.
    ...
    def train_step(self, data: dict,
        ...
        inputs_dict, data_samples, self.mask = \
            data['inputs'], data['data_samples'], data['mask'] # dataset 添加一个输出 input_index
