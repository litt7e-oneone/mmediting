...
from .mask_singan_modules import GeneratorBlock


@MODELS.register_module()
class MaskSinGANMultiScaleGenerator(nn.Module):
    """Multi-Scale Generator used in SinGAN. support multi-image training dataset
    ...
    def forward(self,
        ...
        if input_sample is None:
            input_sample = torch.zeros(
                (num_batches, self.in_channels, fixed_noises[0].shape[-2],
