...
def parse_args():
    ...
    parser.add_argument('--config', default='project/singan/config/collision1.py', help='train config file path')
    parser.add_argument('--work-dir',default='project/singan/collision1', help='the dir to save logs and models')
    parser.add_argument(
